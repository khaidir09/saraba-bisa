<div>
            ...
            <div x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('sales-transaksi-handphone.store') }}" method="post">
                            @csrf
                                    ...
                                    <div>
                                        ...
                                        <select id="phones_id" name="phones_id" class="form-select text-sm py-1 w-full" required>
                                            ...
                                            @foreach ($phones as $phone)
                                                <option value="{{ $phone->id }}">{{ $phone->brand->name }} {{ $phone->modelserie->name }} | Modal {{ number_format($phone->modal) }} | Toko {{ number_format($phone->harga_toko) }} | Pelanggan {{ number_format($phone->harga_pelanggan) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800">Jumlah Transaksi <span class="text-slate-400 font-medium">{{ $phone_transactions_count }}</span></h2>
        </header>
        <!-- Table -->
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @foreach($phone_transactions as $phone)               
                        ...
                        <tr class="{{ $color }}">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <a href="{{ route('sales-transaksi-handphone.edit', $phone->id) }}">
                                    <div class="flex items-center text-blue-600">
                                        <svg class="w-6 h-6 fill-current" viewBox="0 0 32 32">
                                            <path d="M19.7 8.3c-.4-.4-1-.4-1.4 0l-10 10c-.2.2-.3.4-.3.7v4c0 .6.4 1 1 1h4c.3 0 .5-.1.7-.3l10-10c.4-.4.4-1 0-1.4l-4-4zM12.6 22H10v-2.6l6-6 2.6 2.6-6 6zm7.4-7.4L17.4 12l1.6-1.6 2.6 2.6-1.6 1.6z" />
                                        </svg>
                                        <div class="font-medium">{{ $phone->nomor_transaksi }}</div>
                                    </div>
                                </a>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">Rp. {{ number_format($phone->harga) }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">Rp. {{ number_format($phone->diskon) }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            ...
                                            >
                                                <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                    ...
                                                    <div class="px-5 pt-4 pb-1">
                                                        <div class="text-sm">
                                                            <div class="space-y-2">
                                                                <p>Silahkan pilih printer untuk cetak Nota Penjualan Handphone.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Modal footer -->
                                                    <div class="px-5 py-4">
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <a href="{{ route('sales-nota-handphone-termal', $phone->id) }}" target="__blank">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('sales-transaksi-handphone.destroy', $phone->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
