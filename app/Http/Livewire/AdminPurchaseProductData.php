...
class AdminPurchaseProductData extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin-purchase-product-data', [
            'purchases_count' => $purchases_count,
            'returs_count' => $returs_count,
            'trade_ins_count' => $trade_ins_count,
            'purchases' => $this->search === null ?
                Purchase::latest()->whereNull('keterangan')->orWhere('keterangan', '!=', 'Tukar Tambah')->paginate($this->paginate) :
