<div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
    <div x-data="handleSelect">
        <div class="sm:flex sm:justify-between sm:items-center px-5 py-4">
            {{-- Left side --}}
            <h2 class="font-semibold text-slate-800">Semua Kapasitas <span class="text-slate-400 font-medium">{{ $count }}</span></h2>
            {{-- Right side --}}
            ...
            <table class="table-auto w-full">
                ...
                <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Nama Kapasitas</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="flex items-center">
                                    <label class="inline-flex">
                                        ...
                                        <input class="table-item form-checkbox" type="checkbox" value="{{ $capacity->id }}" @click="uncheckParent" />
                                    </label>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">{{ $capacity->id }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">{{ $capacity->name }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('admin-master-kapasitas.edit', $capacity->id) }}">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('admin-master-kapasitas.destroy', $capacity->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
