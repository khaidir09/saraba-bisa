    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-7 bg-white shadow-lg rounded-sm border border-slate-200">
                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="space-x-1 flex">
                                        <form action="{{ url('/produk/sales-cart-update/'.$cart->rowId) }}" method="post">
                                            @csrf
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="space-x-1 flex">
                                        <a href="{{ url('/produk/sales-cart-remove/'.$cart->rowId) }}">
            ...
            <div class="bg-slate-50 p-5 shadow-lg">
                ...
                <div x-data="{ modalOpen: false }">
                    ...
                    >
                        <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                            <form action="{{ route('sales-produk.applyDiscount') }}" method="post">
                                @csrf
                                <div class="px-5 py-4">
                                    <div class="space-y-3">
                                        <div>
                ...
                <form action="{{ url('/produk/sales-complete-order') }}" method="post">
                    @csrf
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y divide-slate-200">
                            ...
                            <form action="{{ url('/produk/sales-add-cart') }}" method="post">
                                @csrf
