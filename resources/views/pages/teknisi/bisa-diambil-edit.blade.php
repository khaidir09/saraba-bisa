                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('teknisi-servis-bisa-diambil.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('teknisi-servis-bisa-diambil.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <input type="hidden" id="users_id" name="users_id" value="{{ $item->users_id }}">
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                <div>
