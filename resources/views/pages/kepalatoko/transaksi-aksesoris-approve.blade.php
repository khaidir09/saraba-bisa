@section('title')
    Persetujuan Transaksi Aksesori
@endsection
            ...
            >
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    <div class="p-6">
                        <div class="relative">
                            <!-- Close button -->
                            <a href="{{ route('transaksi-aksesoris.index') }}">
                            ...
                            <div class="mb-2 text-center">
                                ...
                                <div class="text-lg font-semibold text-slate-800">Persetujuan Transaksi Aksesori</div>
                            </div>
                            <!-- Modal content -->
                            <div class="text-center">
                                <div class="text-sm mb-5">
                                    Apabila tidak ada masalah pada transaksi aksesori yang diinputkan oleh sales, silahkan klik tombol Setuju.
                                </div>
                                <!-- CTAs -->
                                <form action="{{ route('transaksi-aksesoris-approve.update', $item->id) }}" method="post">
                                    @method('PUT')
                                    @csrf
