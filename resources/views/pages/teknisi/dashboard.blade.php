        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="flex flex-col col-span-full xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
                ...
                <div class="h-full flex flex-col px-5 py-3">
                    ...
                    <p class="text-center mt-2 text-xs text-blue-700">Tingkatkan orderan servis hingga Rp. {{ number_format($totalbudgets - ($totalbiayaservis + $totalsparepart + $totalaksesoris + $totalhandphone)) }} lagi!</p>
                </div>
            </div>
