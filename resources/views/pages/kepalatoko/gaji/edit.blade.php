    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Search form -->
                <x-search-form placeholder="Cari berdasarkan nama bonus" />
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Bonus Karyawan</div>
                            <a href="{{ route('bonus.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <form action="{{ route('bonus.update', $item->id) }}" method="post">
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="name">Nama Bonus</label>
                                ...
                                <div>
                                    ...
                                    <select id="users_id" name="users_id" class="form-select text-sm py-1 w-full">
                                        ...
                                        @else
                                            <option selected value="">Data akun telah dihapus</option>
                                        @endif
