<div>
    <div x-data="{ modalOpen: false }">
        <div class="relative">
            <input wire:model="search" id="biaya"
            name="biaya" class="form-input w-full pl-9 px-2 py-1" 
        ...
        <div>
            <select wire:model.defer="biaya" id="biaya" name="biaya" class="form-select w-full mt-2 bg-indigo-500 text-white" x-show="modalOpen">
