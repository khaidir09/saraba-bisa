<div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
    <div x-data="handleSelect">
        <div class="sm:flex sm:justify-between sm:items-center px-5 py-4">
            {{-- Left side --}}
            <h2 class="font-semibold text-slate-800">Semua Insiden <span class="text-slate-400 font-medium">{{ $count }}</span></h2>
            {{-- Right side --}}
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @foreach($incidents as $item)                  
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">{{ number_format($item->price) }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('admin-insiden.edit', $item->id) }}">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('admin-insiden.destroy', $item->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
