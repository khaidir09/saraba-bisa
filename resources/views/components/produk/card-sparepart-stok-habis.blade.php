    ...
    <div class="px-5 p-5">
        ...
        <div class="flex justify-between">
            <div>
                ...
                <div class="text-xl font-bold text-blue-500">{{ $sparepartstokhabis }}</div>
            </div>
            <div>
                <div class="text-xs font-semibold text-slate-400 uppercase mb-1">Nominal</div>
                <div class="text-xl font-bold text-emerald-500">Rp. {{ number_format($sparepartnominalterjual) }}</div>
            </div>
        </div>
    </div>
</div>