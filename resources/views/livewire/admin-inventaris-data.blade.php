                        ...
                        <form action="{{ route('admin-inventaris.store') }}" method="post">
                            ...
                            <div class="px-5 py-4 border-t border-slate-200">
                                <div class="flex flex-wrap justify-end space-x-2">
                                    <a href="{{ route('admin-inventaris.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                        Batal
                                    </a>
                ...
                <table class="table-auto w-full">
                    ...
                    <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Tanggal Pembelian</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Masa Penggantian</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <tbody class="text-sm divide-y divide-slate-200">
                        ...
                        @foreach($inventories as $item)                  
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    @if ($item->masa_penggantian < \Carbon\Carbon::now())
                                        <div class="font-medium text-red-600">{{ \Carbon\Carbon::parse($item->masa_penggantian)->format('d/m/Y') }}</div>
                                    @else
                                        <div class="font-medium text-blue-600">{{ \Carbon\Carbon::parse($item->masa_penggantian)->format('d/m/Y') }}</div>
                                    @endif
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
