...
class InventarisController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages/admintoko/inventaris/index', compact('inventories', 'expenses_count'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.admintoko.inventaris.approve', [
            'item' => $item
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admintoko.inventaris.edit', [
            'item' => $item
        ]);
    }
