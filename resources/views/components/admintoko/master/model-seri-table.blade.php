<div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">Semua Model Seri <span class="text-slate-400 font-medium">{{ $count }}</span></h2>
    </header>
    <!-- Table -->
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                            <div class="space-x-1 flex">
                                <a href="{{ route('admin-master-model-seri.edit', $model->id) }}">
                                            ...
                                            <div class="p-5 flex space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex flex-wrap justify-end space-x-2">
                                                        ...
                                                        <form action="{{ route('admin-master-model-seri.destroy', $model->id) }}" method="post">
                                                            @method('delete')
                                                            @csrf
