                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Transaksi Aksesori</div>
                            <a href="{{ route('sales-transaksi-aksesoris.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('sales-transaksi-aksesoris.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    <small class="text-xs text-blue-600">Jika terdapat kesalahan penginputan item aksesori dan jumlah, silahkan hapus transaksi, kembalikan stok data aksesorinya dan input transaksi kembali</small>
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('sales-transaksi-aksesoris.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
