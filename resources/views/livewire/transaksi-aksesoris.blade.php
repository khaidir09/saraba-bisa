                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @foreach($accessory_transactions as $item)               
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <a href="{{ route('transaksi-aksesoris.edit', $item->id) }}">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <a href="{{ route('transaksi-aksesoris-approve.edit', $item->id) }}">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('transaksi-aksesoris.destroy', $item->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
