                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('admin-transaksi-handphone.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('admin-transaksi-handphone.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('admin-transaksi-handphone.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
