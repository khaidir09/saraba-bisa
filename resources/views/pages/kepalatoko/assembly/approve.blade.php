                    ...
                    <div class="p-6">
                        <div class="relative">
                            ...
                            <div class="mb-2 text-center">
                                ...
                                <div class="text-lg font-semibold text-slate-800">Persetujuan Perakitan & Pengecekan</div>
                            </div>
                            <!-- Modal content -->
                            <div class="text-center">
                                <div class="text-sm mb-5">
                                    Apabila tidak ada masalah pada item Perakitan & Pengecekan yang diinputkan oleh admin, silahkan klik tombol Setuju.
                                </div>
                                <!-- CTAs -->
                                <form action="{{ route('assembly.update', $item->id) }}" method="post">
                                    @method('PUT')
                                    @csrf
