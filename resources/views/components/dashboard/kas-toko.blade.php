    ...
    <div class="px-5 py-6">
        ...
        <div class="xl:flex xl:justify-between md:items-center">
            ...
            <div class="flex items-center py-2">
                <div class="mr-5">
                    <div class="flex items-center">
                        <div class="text-3xl font-bold text-blue-600 mr-2">Rp. {{ number_format($totalomzet) }}</div>
                    </div>
            ...
            <div class="flex items-center py-2">
                <div class="mr-5">
                    <div class="flex items-center">
                        <div class="text-3xl font-bold text-green-800 mr-2">Rp. {{ number_format($totalprofitutuh) }}</div>
                    </div>
