            ...
            <div x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('admin-master-jenis-barang.store') }}" method="post">
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                            ...
                            <tr>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="flex items-center">
                                        <label class="inline-flex">
                                            ...
                                            <input class="table-item form-checkbox" type="checkbox" value="{{ $type->id }}" @click="uncheckParent" />
                                        </label>
                                    </div>
                                </td>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="space-x-1 flex">
                                        <a href="{{ route('admin-master-jenis-barang.edit', $type->id) }}">
                                                    ...
                                                    <div class="p-5 flex space-x-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="flex flex-wrap justify-end space-x-2">
                                                                ...
                                                                <form action="{{ route('admin-master-jenis-barang.destroy', $type->id) }}" method="post">
                                                                    @method('delete')
                                                                    @csrf
