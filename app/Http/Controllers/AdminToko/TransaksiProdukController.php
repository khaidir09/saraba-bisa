...
class TransaksiProdukController extends Controller
{
    ...
    public function show($orders_id)
    {
        ...
        return view('pages.admintoko.produk.transaksi-detail', compact('order', 'orderItem', 'total', 'subtotal'));
    }
    ...
    public function cetaktermal($orders_id)
    {
        ...
        $pdf = PDF::loadView('pages.admintoko.produk.cetak-termal', [
            'order' => $order,
            'users' => $users,
            'orderItem' => $orderItem,
            'total' => $total,
    ...
    public function cetakinkjet($orders_id)
    {
        ...
        $pdf = PDF::loadView('pages.admintoko.produk.lunas-cetak-inkjet', [
            'order' => $order,
            'users' => $users,
            'orderItem' => $orderItem,
            'total' => $total,
