<div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">Semua Pengeluaran <span class="text-slate-400 font-medium">{{ $count }}</span></h2>
    </header>
        <!-- Table -->
            ...
            <table class="table-auto w-full">
                ...
                <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Nama Pengeluaran</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Biaya</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="font-semibold text-left">Dibebankan</div>
                        </th>
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @foreach($expenses as $item)
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium text-red-600">Rp. {{ number_format($item->pengeluaran_teknisi) }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('teknisi-pengeluaran.edit', $item->id) }}">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('teknisi-pengeluaran.destroy', $item->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
