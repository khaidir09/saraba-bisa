                        ...
                        <form action="{{ route('teknisi-transaksi-servis.store') }}" method="post">
                            ...
                            <div class="px-5 py-4 border-t border-slate-200">
                                <div class="flex flex-wrap justify-between space-x-2">
                                    ...
                                    <div>
                                        <a href="{{ route('teknisi-servis-bisa-diambil.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                            Batal
                                        </a>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="mb-4 sm:mb-0">
            <ul class="flex flex-wrap -m-1">
                ...
                <li class="m-1">
                    <a href="{{ route('teknisi-servis-bisa-diambil.index') }}">
                ...
                <li class="m-1">
                    <a href="{{ route('teknisi-servis-sudah-diambil.index') }}">
            ...
            <table class="table-auto w-full">
                ...
                <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
                    <tr>
                        ...
                        @if ($pajaktoko->is_tax === 1)
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">PPN 11%</div>
                            </th>
                        @endif
                        <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    ...
                                    >
                                        <a href="{{ route('teknisi-ubah-sudah-diambil-edit', $transaction->id) }}">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('teknisi-servis-bisa-diambil.destroy', $transaction->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
