<div>
            ...
            <div x-data="{ modalOpen: false }">
                ...
                >
                    <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                        ...
                        <!-- Modal content -->
                        <form action="{{ route('admin-transaksi-aksesoris.store') }}" method="post">
                            @csrf
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mt-5 mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800">Jumlah Transaksi <span class="text-slate-400 font-medium">{{ $accessory_transactions_count }}</span></h2>
        </header>
        <!-- Table -->
            ...
            <table class="table-auto w-full">
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @php
                        $i = 1
                    @endphp
                    @foreach($accessory_transactions as $item)               
                        @php                    
                            if ($item->profit < '0') :
                                $color = 'text-red-600';
                            else :
                        ...
                        <tr class="{{ $color }}">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <a href="{{ route('admin-transaksi-aksesoris.edit', $item->id) }}">
                                            ...
                                            >
                                                <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                    ...
                                                    <div class="px-5 pt-4 pb-1">
                                                        <div class="text-sm">
                                                            <div class="space-y-2">
                                                                <p>Silahkan pilih printer untuk cetak Nota Penjualan Aksesori.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Modal footer -->
                                                    <div class="px-5 py-4">
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <a href="{{ route('admin-nota-aksesori-termal', $item->id) }}" target="__blank">
