...
<x-toko-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                            ...
                            @csrf
                                ...
                                <div class="px-5 py-4">
                                    <div class="flex flex-wrap justify-end space-x-2">
                                        <a href="{{ asset('storage/assets/format-model.xlsx') }}" class="btn-sm bg-orange-500 hover:bg-orange-600 text-white">
                                            <span class="mr-1">
        ...
        <!-- Table -->
        <x-master.model-seri-table :models="$models" :count="$models_count" />
