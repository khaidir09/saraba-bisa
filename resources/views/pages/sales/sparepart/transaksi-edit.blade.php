    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Transaksi Sparepart ✨</h1>
            </div>
                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            <div class="font-semibold text-slate-800">Edit Transaksi Sparepart</div>
                            <a href="{{ route('sales-transaksi-sparepart.index') }}" class="text-slate-400 hover:text-slate-500">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('sales-transaksi-sparepart.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input id="quantity" name="quantity" class="form-input w-full px-2 py-1" type="number" value="{{ $item->quantity }}"/>
                                </div>
                                <div>
                                ...
                                <div>
                                    <small class="text-xs text-blue-600">Jika terdapat kesalahan penginputan item sparepart dan jumlah, silahkan hapus transaksi, minta admin untuk mengembalikan stok data sparepartnya dan input transaksi kembali</small>
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('sales-transaksi-sparepart.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
