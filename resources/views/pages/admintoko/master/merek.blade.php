    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-3">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Search form -->
                <x-search-form placeholder="Cari berdasarkan nama merek" />
        ...
        <!-- More actions -->
        <div class="sm:flex sm:justify-end sm:items-center mb-5 gap-2">
            <!-- Start Export Excel -->
        ...
        <!-- Table -->
        <x-admintoko.master.merek-table :brands="$brands" :count="$brands_count" />
